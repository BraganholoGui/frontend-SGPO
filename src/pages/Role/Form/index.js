      ...
      <S.Container>
        ...
        <FormContent>
          <S.ContentBox>
            ...
            <InputForm options={statusOptions} selected={permissionSelected} setSelected={setPermissionSelected} value={permissionSelected} setValue={setPermissionSelected} title="Permissão" type='select' size="small"></InputForm>
          </S.ContentBox>
